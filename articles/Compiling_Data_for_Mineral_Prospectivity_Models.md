...
** For example a grid gravity readings in addition to a colored image with RGB values
...
* Build topology (https://en.wikipedia.org/wiki/Geospatial_topology) if it's important to consider contact relationships
